...
const PLACEHOLDER_PERSON = "/user-3.webp";
...
export const RESULTS: Result[] = [
  ...
  },
  {
    ...
    category: "Prototype, solar",
    result: "1st place",
    image: "/result/2010_USA.webp"
  }
];

export const PARTNERS: Partner[] = [
  { name: "Politecnico di Milano", logo: "/sponsor/03_Polimi_bandiera-1riga_COL_positivo.webp", url: "https://www.polimi.it/" },
  { name: "Mecc Polimi", logo: "/sponsor/logoMecc.webp", url: "https://www.mecc.polimi.it/" },
  { name: "Maxon", logo: "/sponsor/logo_Maxon.webp", url: "https://www.maxongroup.it/" },
  { name: "Brembo", logo: "/sponsor/Brembo_logo_(2022).svg.webp", url: "https://www.brembo.com/" },
  { name: "Ansys", logo: "/sponsor/Ansys_logo_(2019).svg.webp", url: "https://www.ansys.com/" },
  { name: "Altair", logo: "/sponsor/1200px-Altair_logo.webp", url: "https://altair.com/" },
  { name: "Discacciati", logo: "/sponsor/discacciati-logo.webp", url: "#" },
  { name: "Ghioni", logo: "/sponsor/Ingranaggi_Ghioni_logo.webp", url: "#" },
  { name: "CIT", logo: "/sponsor/logo_CIT.webp", url: "#" },
  { name: "Mako Shark", logo: "/sponsor/makoSharkMod.webp", url: "#" },
];
...
export const DEPARTMENTS_INFO: DepartmentInfo[] = [
  {
    ...
    icon: "/departments/structure.svg",
  ...
  },
  {
    id: "management",
    title: "Management",
    icon: "/departments/management-3.svg",
  ...
  },
  {
    id: "drivetrain",
    title: "Drivetrain",
    icon: "/departments/engineering.svg",
  ...
  },
  {
    id: "aerodynamics",
    title: "Aerodynamics",
    icon: "/departments/aerodynamic.svg",
  ...
  },
  {
    id: "communication",
    title: "Communication",
    icon: "/departments/bullhorn-2.svg",
